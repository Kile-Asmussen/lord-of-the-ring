...
The Bear comes over to you to finish the job, heedless of its fur being on fire. The shrubbery and undergrowth is set alight, too.
...
Staggering over to the corpse, you call to the flames crawling over its fur and quell them. It takes a toll on you, but it is either that or letting the forest burn down entire --- a conflagration it will be difficult to outpace.
